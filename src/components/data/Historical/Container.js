        ...
        if (data.length === 10) {
          if (data[0].year_month_day[3] === "8")
            { let o17_year = data[9].year_month_day.slice(0,4), o17_tmax = parseInt(data[9].tmax, 10), o17_tmin = parseInt(data[9].tmin, 10), o17_tavg = parseInt(data[9].tavg, 10)
              this.setState({ o17_year: o17_year, o17_tmax: o17_tmax, o17_tmin: o17_tmin, o17_tavg: o17_tavg }) }
          else
            { let o07_year = data[9].year_month_day.slice(0,4), o07_tmax = parseInt(data[9].tmax, 10), o07_tmin = parseInt(data[9].tmin, 10), o07_tavg = parseInt(data[9].tavg, 10)
              this.setState({ o07_year: o07_year, o07_tmax: o07_tmax, o07_tmin: o07_tmin, o07_tavg: o07_tavg }) }
          }
